...
if ( 'yes' === get_option( 'woocommerce_registration_generate_password' ) && $password_generated )
    echo sprintf( __( "Set up a password here: %s.", 'woocommerce' ), woo_new_account_password_reset_link( $user_login ) ) . "\n\n";

echo sprintf( __( 'You can access your account area to view your orders here: %s.', 'woocommerce' ), wc_get_page_permalink( 'myaccount' ) ) . "\n\n";
